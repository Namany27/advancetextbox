...
with gr.Blocks(
    ...
    gr.Markdown(
"""
# `gradio_advancetextbox`

<div style="display: flex; gap: 7px;">
<img alt="Static Badge" src="https://img.shields.io/badge/version%20-%200.0.1%20-%20orange">  
</div>

This is a textbox with some extra button not just copy
...
```bash
pip install gradio_advancetextbox
```
...
""", elem_classes=["md-custom"], header_links=True)
    ...
    gr.ParamViewer(value=_docs["AdvanceTextbox"]["members"]["__init__"], linkify=[])


    gr.Markdown("### Events")
    gr.ParamViewer(value=_docs["AdvanceTextbox"]["events"], linkify=['Event'])
...
def predict(
    ...
    return value
```
""", elem_classes=["md-custom", "AdvanceTextbox-user-fn"], header_links=True)
