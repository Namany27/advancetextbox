...
class AdvanceTextbox(FormComponent):
    """
    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            show_download_button: If True, includes a copy button to copy the text in the textbox. Only applies if show_label is True.
